...
class ArtRecyclerAdapter @Inject constructor(
    ...
    override fun onBindViewHolder(holder: ArtViewHolder, position: Int) {
        val imageView = holder.itemView.findViewById<ImageView>(R.id.ivRow)
        val nameText = holder.itemView.findViewById<TextView>(R.id.tvRowName)
        val artistNameText = holder.itemView.findViewById<TextView>(R.id.tvRowArtistName)
        val yearText = holder.itemView.findViewById<TextView>(R.id.tvRowYear)
